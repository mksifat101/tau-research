# Generated by Django 3.2 on 2022-04-25 15:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sector', '0002_alter_sector_create_date'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('p_token', models.CharField(max_length=150, null=True)),
                ('create_date', models.DateTimeField(auto_now_add=True, null=True)),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='authentication.org')),
            ],
        ),
    ]
